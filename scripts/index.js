...
async function mode_initialize(int) {
    ...
    xhr.onreadystatechange = function () {
        if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            navbar.appendChild(icon.firstChild);
        }
    };
}
